...
// Allows requests from localhost (for local testing) and the live Netlify site
app.use(
  cors({
    origin: (process.env.CORS_ORIGIN || "http://localhost:3000,https://oscar-gold-store.netlify.app").split(","),
    credentials: true,
  })
);
